...
import { Database, BarChart3, Columns3, Calendar, FileText, Image, ClipboardList, GitCommitVertical, Network, GanttChartSquare, ChevronDown, ChevronRight } from 'lucide-react';
